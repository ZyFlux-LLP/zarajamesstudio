    ...
    <>
      ...
      <header className="relative pt-40 pb-20 md:pt-60 md:pb-32 px-6 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden">
             <img src="/projects/London/8.jpg" className="w-full h-full object-cover opacity-10 dark:opacity-50 grayscale" alt="Shadows" />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
                <div className="order-2 lg:order-1 relative">
                     <RevealImage className="aspect-[3/4] cursor-pointer group overflow-hidden flex items-center justify-center" onClick={() => openLightbox(['/bakuli.jpeg'])}>
                        <img alt="Bakuli Sangamneheri" className="w-full h-full object-contain object-center grayscale contrast-110 group-hover:grayscale-0 transition-all duration-1000" src="/bakuli.jpeg"/>
                     </RevealImage>
