...
const Home: React.FC = () => {
  ...
  // Kensington project images for hero carousel
  const heroImages = Array.from({ length: 16 }, (_, i) => `/projects/Kensington/${i + 1}.jpg`);
    ...
    <>
      ...
      <header className="relative h-screen w-full flex flex-col justify-center items-center overflow-hidden">
        ...
        >
            <img
              ...
              className="w-full h-full object-cover object-center opacity-85 dark:opacity-55"
              src="/projects/Kensington/2.jpg"
            />
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto text-white">
          ...
          <Reveal delay={0.6}>
            <div className="mt-8">
                <Link to="/projects" className="inline-block border border-white/30 text-white px-10 py-4 text-xs tracking-widest uppercase hover:bg-white hover:text-black transition-all duration-500 ease-out backdrop-blur-sm">
                    Explore Work
                </Link>
            </div>
          </Reveal>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
                <img
                    alt="Interior detail"
                    className="w-full h-full object-contain object-center grayscale hover:grayscale-0 transition-all duration-1000"
                    src="/projects/Kensington/1.jpg"
                />
            ...
            <div className="order-1 md:order-2 space-y-8 md:pl-12">
                ...
                <Reveal delay={0.4}>
                    <div className="pt-4">
                        <Link to="/studio" className="text-xs tracking-widest uppercase hover-underline-animation hover:text-accent-gold transition-colors">
                            Read Our Philosophy
                        </Link>
                    </div>
                </Reveal>
      ...
      <section className="py-20 px-6 md:px-12 bg-white dark:bg-[#0f0f0f]">
        <div className="max-w-[1920px] mx-auto">
            <div className="flex justify-between items-end mb-16">
                ...
                <Link to="/projects" className="hidden md:block text-xs tracking-widest uppercase hover:text-accent-gold transition-colors hover-underline-animation">View All Projects</Link>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {/* Project 1 */}
                <div className="group cursor-pointer" onClick={() => openLightbox(heroImages, 1)}>
                    <RevealImage className="aspect-[4/5] mb-6 flex items-center justify-center overflow-hidden">
                        <img alt="Kensington" className="w-full h-full object-cover object-center transform group-hover:scale-105 transition-transform duration-1000" src="/projects/Kensington/2.jpg"/>
                    </RevealImage>
                    <Reveal delay={0.2}>
                ...
                {/* Project 2 */}
                <div className="group cursor-pointer md:mt-12" onClick={() => openLightbox(Array.from({ length: 7 }, (_, i) => `/projects/Chesilton/${i + 1}.jpg`), 0)}>
                    <RevealImage className="aspect-[4/5] mb-6 flex items-center justify-center overflow-hidden" delay={0.2}>
                         <img alt="Chesilton" className="w-full h-full object-cover object-center transform group-hover:scale-105 transition-transform duration-1000" src="/projects/Chesilton/1.jpg"/>
                    </RevealImage>
                    <Reveal delay={0.4}>
                        <div className="flex justify-between items-baseline border-t border-black/10 dark:border-white/10 pt-4 pr-2">
                            <div className="flex-1">
                ...
                {/* Project 3 */}
                <div className="group cursor-pointer" onClick={() => openLightbox(['/projects/Jio World Convention Centre Commercial/1.jpg'], 0)}>
                    <RevealImage className="aspect-[4/5] mb-6 flex items-center justify-center overflow-hidden" delay={0.4}>
                         <img alt="Jio World Convention Centre" className="w-full h-full object-cover object-center transform group-hover:scale-105 transition-transform duration-1000" src="/projects/Jio World Convention Centre Commercial/1.jpg"/>
                    </RevealImage>
                     <Reveal delay={0.6}>
                        <div className="flex justify-between items-baseline border-t border-black/10 dark:border-white/10 pt-4 pr-2">
                            <div className="flex-1">
            ...
            <div className="mt-12 text-center md:hidden">
                 <Link to="/projects" className="text-xs tracking-widest uppercase hover-underline-animation">View All Projects</Link>
            </div>
        </div>
      </section>
      ...
      <section className="relative py-32 md:py-48 flex items-center justify-center bg-fixed bg-center bg-cover overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden">
             <img src="/projects/London/5.jpg" className="w-full h-full object-cover" alt="Texture"/>
