    ...
    <>
      ...
      <header className="relative pt-40 pb-20 md:pt-60 md:pb-32 px-6 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden">
             <img src="/projects/London/8.webp" className="w-full h-full object-cover opacity-10 dark:opacity-50 grayscale" alt="Shadows" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
             <Reveal>
                ...
                <h1 className="font-display text-6xl md:text-8xl lg:text-9xl font-normal leading-[0.9] text-primary dark:text-white">
      ...
      <section className="w-full px-4 md:px-8 pb-12 md:pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 h-auto">
            <RevealImage className="h-[40vh] md:h-[90vh] cursor-pointer overflow-hidden flex items-center justify-center" onClick={() => openLightbox(['/projects/Bathroom Design/1.webp', '/projects/Bathroom Design/2.webp'])}>
                <img alt="Materiality" className="w-full h-full object-contain object-center" src="/projects/Bathroom Design/1.webp"/>
            ...
            <RevealImage className="h-[40vh] md:h-[90vh] mt-4 md:mt-24 cursor-pointer overflow-hidden flex items-center justify-center" delay={0.3} onClick={() => openLightbox(['/projects/waterford/2.webp', '/projects/waterford/1.webp', '/projects/waterford/3.webp', '/projects/waterford/4.webp', '/projects/waterford/5.webp', '/projects/waterford/6.webp', '/projects/waterford/7.webp', '/projects/waterford/8.webp'])}>
                 <img alt="Atmosphere" className="w-full h-full object-contain object-center" src="/projects/waterford/2.webp"/>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
                <div className="order-2 lg:order-1 relative">
                     <RevealImage className="aspect-[3/4] cursor-pointer group overflow-hidden flex items-center justify-center" onClick={() => openLightbox(['/bakuli.webp'])}>
                        <img alt="Bakuli Sangamneheri" className="w-full h-full object-contain object-center grayscale contrast-110 group-hover:grayscale-0 transition-all duration-1000" src="/bakuli.webp"/>
                     </RevealImage>
