    ...
    <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="group cursor-pointer" onClick={() => openLightbox(heroImages, 1)}>
                    <RevealImage className="aspect-[4/5] mb-6 flex items-center justify-center overflow-hidden">
                        <img alt="Kensington" className="w-full h-full object-cover object-center transform group-hover:scale-105 transition-transform duration-1000" src="/projects/Kensington/2.webp"/>
                    </RevealImage>
                    <Reveal delay={0.2}>
                ...
                <div className="group cursor-pointer md:mt-12" onClick={() => openLightbox(Array.from({ length: 7 }, (_, i) => `/projects/Chesilton/${i + 1}.webp`), 0)}>
                    <RevealImage className="aspect-[4/5] mb-6 flex items-center justify-center overflow-hidden" delay={0.2}>
                         <img alt="Chesilton" className="w-full h-full object-cover object-center transform group-hover:scale-105 transition-transform duration-1000" src="/projects/Chesilton/1.webp"/>
                    </RevealImage>
                    <Reveal delay={0.4}>
                        <div className="flex justify-between items-baseline border-t border-black/10 dark:border-white/10 pt-4 pr-2">
                            <div className="flex-1">
                ...
                <div className="group cursor-pointer" onClick={() => openLightbox(['/projects/Jio World Convention Centre Commercial/1.webp'], 0)}>
                    <RevealImage className="aspect-[4/5] mb-6 flex items-center justify-center overflow-hidden" delay={0.4}>
                         <img alt="Jio World Convention Centre" className="w-full h-full object-cover object-center transform group-hover:scale-105 transition-transform duration-1000" src="/projects/Jio World Convention Centre Commercial/1.webp"/>
                    </RevealImage>
                     <Reveal delay={0.6}>
                        <div className="flex justify-between items-baseline border-t border-black/10 dark:border-white/10 pt-4 pr-2">
                            <div className="flex-1">
      ...
      <section className="relative py-32 md:py-48 flex items-center justify-center bg-fixed bg-center bg-cover overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden">
             <img src="/projects/London/5.webp" className="w-full h-full object-cover" alt="Texture"/>
